...
## Note, this is a slightly adjusted version of:
## https://github.com/godotengine/godot-demo-projects/tree/master/xr/openxr_hand_tracking_demo
## Mainly we've moved palm/grip offset code into select_hand_tracker.gd
...
func _process_modification() -> void:
	...
	for i in bone_count:
		...
		if bone_name == "LeftIndexDistal" or bone_name == "LeftIndexIntermediate" \
